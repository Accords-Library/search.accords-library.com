...
export type LibraryItemMetadataDynamicZone = ComponentMetadataAudio | ComponentMetadataBooks | ComponentMetadataGame | ComponentMetadataGroup | ComponentMetadataOther | ComponentMetadataVideo | Error;
...
export type RangedContentRangeDynamicZone = ComponentRangeOther | ComponentRangePageRange | ComponentRangeTimeRange | Error;
...
export type GetVideoQuery = { __typename?: 'Query', video?: { __typename?: 'VideoEntityResponse', data?: { __typename?: 'VideoEntity', id?: string | null, attributes?: { __typename?: 'Video', uid: string, title: string, description: string, views: number, gone: boolean, duration: number, published_date: { __typename?: 'ComponentBasicsDatepicker', year?: number | null, month?: number | null, day?: number | null }, channel?: { __typename?: 'VideoChannelEntityResponse', data?: { __typename?: 'VideoChannelEntity', attributes?: { __typename?: 'VideoChannel', title: string, uid: string } | null } | null } | null } | null } | null } | null };
...
export type PricePickerFragment = { __typename?: 'ComponentBasicsPrice', amount?: number | null, currency?: { __typename?: 'CurrencyEntityResponse', data?: { __typename?: 'CurrencyEntity', attributes?: { __typename?: 'Currency', symbol: string, code: string, rate_to_usd: number } | null } | null } | null };

export type UploadImageFragment = { __typename?: 'UploadFile', name: string, alternativeText?: string | null, caption?: string | null, width?: number | null, height?: number | null, url: string };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getContents(variables?: GetContentsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetContentsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetContentsQuery>(GetContentsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getContents', 'query');
    },
    getLibraryItem(variables?: GetLibraryItemQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetLibraryItemQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetLibraryItemQuery>(GetLibraryItemDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getLibraryItem', 'query');
    },
    getLibraryItems(variables?: GetLibraryItemsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetLibraryItemsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetLibraryItemsQuery>(GetLibraryItemsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getLibraryItems', 'query');
    },
    ...
    getVideo(variables?: GetVideoQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetVideoQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetVideoQuery>(GetVideoDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getVideo', 'query');
    },
    getVideos(variables?: GetVideosQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetVideosQuery> {
    ...
    getWeapon(variables?: GetWeaponQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetWeaponQuery> {
    ...
    getWeapons(variables?: GetWeaponsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetWeaponsQuery> {
    ...
    getWikiPage(variables?: GetWikiPageQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetWikiPageQuery> {
    ...
    getWikiPages(variables?: GetWikiPagesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetWikiPagesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetWikiPagesQuery>(GetWikiPagesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getWikiPages', 'query');
    }
  };
}
