...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getContents(variables?: GetContentsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetContentsQuery> {
    ...
    getLibraryItem(variables?: GetLibraryItemQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetLibraryItemQuery> {
    ...
    getLibraryItems(variables?: GetLibraryItemsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetLibraryItemsQuery> {
    ...
    getWikiPages(variables?: GetWikiPagesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetWikiPagesQuery> {
